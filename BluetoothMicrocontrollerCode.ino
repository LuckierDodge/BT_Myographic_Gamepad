...
//  delay(500);
  ...
  Serial.begin(115200);
  Serial.println(F("ddiLab Muscle-driven Controller"));
  Serial.println(F("---------------------------------------"));
  ...
  Serial.println(F("Setting device name to 'Muscle-driven Controller': "));
  if (! ble.sendCommandCheckOK(F( "AT+GAPDEVNAME=Muscle-driven Controller" )) ) {
